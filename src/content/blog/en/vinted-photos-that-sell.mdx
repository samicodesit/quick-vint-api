...
<ProductMention
  title="Tip: good photos also make AI descriptions more accurate"
  body="AutoLister AI reads your photos to generate descriptions. Clear, well-lit photos with visible labels and details produce better text output."
/>
