...
Here is what buyers check, in order.
...
A window + a clean surface is enough for most Vinted photos.
...
A mirror selfie, mannequin, or hanger shot is enough when it communicates the shape.

## The thumbnail matters most

On Vinted's grid, buyers see a small square thumbnail. That first image decides whether they open the listing.
