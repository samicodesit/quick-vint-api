...
Skip measurements for basic items where the size is obvious. Add them when buyers cannot judge fit from the label alone.
...
Fix clarity first: photo, title, description, condition proof.
