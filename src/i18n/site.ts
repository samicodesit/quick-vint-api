...
export const SITE_COPY: Record<SiteLocale, SiteCopy> = {
  ...
  fr: {
    ...
    home: {
      seoTitle: "AutoLister AI - Le meilleur generateur de descriptions Vinted",
      seoDescription:
        "Le meilleur outil IA pour Vinted qui genere des descriptions depuis des photos, rapidement et en toute securite.",
      heroTitle: "Le seul assistant IA Vinted dont vous avez besoin.",
      heroSubtitle:
        "Gagnez du temps. AutoLister transforme vos photos en annonces Vinted optimisees en quelques secondes.",
      heroBadgeSafe: "100% Securise · Conforme aux regles Vinted",
      heroBulletSafety:
    ...
    pricing: {
      ...
      seoDescription:
        "Decouvrez nos offres simples et transparentes pour AutoLister AI.",
      heading: "Tarifs",
      headingAccent: "Transparents",
      subtitle: "Choisissez l'offre adaptee a votre profil vendeur.",
      subtitleLine2: "Montez ou baissez a tout moment.",
    },
  },
  de: {
  ...
  nl: {
    ...
    pricing: {
      ...
      seoDescription: "Ontdek simpele en transparante prijzen voor AutoLister AI.",
  ...
  es: {
    ...
    home: {
      seoTitle: "AutoLister AI - El mejor generador de descripciones para Vinted",
      seoDescription:
    ...
    pricing: {
      ...
      seoDescription: "Descubre planes simples y transparentes para AutoLister AI.",
  ...
  pt: {
    ...
    pricing: {
      ...
      seoDescription: "Descubra planos simples e transparentes para o AutoLister AI.",
...
> = {
  en: {
    home: {
      ...
      heroBullet1: "Generates SEO-ready titles, descriptions, and hashtags automatically",
      ...
      safetyBody: "Unlike DotB and Vintex — which hook into Vinted's private API to mass auto-follow and auto-like — AutoLister operates strictly as a browser productivity tool. It writes text for you. Nothing more.",
      ...
      safetyCoreBody: "AutoLister acts exactly like a human typing very fast. We never touch private APIs or automate likes/follows. Zero mass actions.",
      ...
      safetyFeature1Body: "We never touch Vinted's internal code or private endpoints — zero Cloudflare triggers.",
      safetyFeature2Title: "Human-Paced",
      safetyFeature2Body: "We fill in text fields for you — like a very fast typist. No mass actions, no spam loops.",
      safetyFeature3Title: "Your Wallet Stays Safe",
      safetyFeature3Body: "You review every listing before it goes live. Your Vinted wallet and account are never at risk.",
      ...
      comparisonBotBullet1Body: "Hook into Vinted's private API — community reports bans within weeks of use",
      comparisonBotBullet2Title: "Cloudflare bot detection triggers",
      comparisonBotBullet2Body: "500 daily auto-likes & auto-follows flag your account as automated traffic",
      comparisonBotBullet3Title: "Violates Vinted's Terms of Service",
      comparisonBotBullet3Body: "Automating Vinted actions via private API is explicitly prohibited in their ToS",
      comparisonBotBullet4Title: "Your Vinted wallet at risk",
      comparisonBotBullet4Body: "Account ban = wallet frozen. Any money on the platform could be locked instantly",
      comparisonAlBullet1Title: "Zero ban risk",
      comparisonAlBullet1Body: "Reads your photo, writes your listing text — identical behaviour to a human seller",
      comparisonAlBullet2Title: "Zero Cloudflare triggers",
      comparisonAlBullet2Body: "No private API calls. No mass actions. Completely invisible to bot detection.",
      comparisonAlBullet3Title: "100% Vinted ToS compliant",
      comparisonAlBullet3Body: "A writing assistant, not a bot. Helps you create better listings, fully within the rules.",
      comparisonAlBullet4Title: "Your wallet stays protected",
      comparisonAlBullet4Body: "No account risk, no frozen funds. List more, worry less.",
      comparisonFootnote: "Comparison based on publicly advertised features of DotB and Vintex as of 2025. AutoLister AI is not affiliated with or endorsed by Vinted.",
      featuresTitle: "A Faster Way to Sell on Vinted",
      featuresSubtitle: "Snap. Scan. Sell. From your camera roll to Vinted listing in just a few seconds.",
      feature1Title: "Conversion-Optimized",
      feature1Body: "Every title and description is crafted to maximize appeal and drive sales using proven copywriting principles.",
      feature2Title: "Seamless Workflow",
      feature2Body: "No more excuses for not selling those clothes lying around. Experience the seamless flow from photo to published listing.",
      feature3Title: "Smart AI Technology",
      feature3Body: "Powered by advanced language models that understand fashion trends, buyer psychology, and Vinted best practices.",
      howItWorksTitle: "How It Works",
      howItWorksSubtitle: "Get professional listings in three simple steps",
      step1Title: "Install Extension",
      step1Body: "Add the Vinted generator to your browser in seconds. It's free to get started.",
      step2Title: "Add Photos & Generate",
      step2Body: "Upload photos directly to Vinted, or use our mobile feature to snap and sync. Then just click Generate.",
      step3Title: "Publish & Sell",
      step3Body: "Review, customize if needed, and publish your optimized listing. Watch your sales improve!",
      finalCtaTitle: "Ready to Transform Your Vinted Sales?",
      finalCtaBody: "Join thousands of successful sellers who use AutoLister to create professional listings that sell faster. Turn your closet into a boutique today.",
      getStartedFree: "Get Started Free",
    },
    pricing: {
      safetyBannerTitle: "The only Vinted tool your account is genuinely safe with.",
  ...
  fr: {
    home: {
      ...
      videoCaption: "Voyez le resultat en 15 secondes",
      heroBullet1: "Genere des titres, descriptions et hashtags SEO automatiquement",
      heroBullet2: "Aucun copier-coller. Aucun envoi de photos par e-mail.",
      heroBullet3: "Conforme aux conditions generales de Vinted",
      addToChrome: "Ajouter a Chrome",
      addToChromeNote: "C'est gratuit",
      safetyHeading: "Zero risque. 100% de controle.",
      safetyBody: "Contrairement a DotB et Vintex — qui se connectent a l'API privee de Vinted — AutoLister est un simple outil de redaction. Il ecrit du texte pour vous. Rien de plus.",
      safetyNativeBadge: "Extension navigateur 100% native",
      safetyCoreBadge: "La difference cle",
      safetyCoreTitle: "Le risque n'est pas l'IA.",
      safetyCoreSubtitle: "Le risque, c'est l'automatisation des actions sur Vinted.",
      safetyCoreBody: "AutoLister agit comme un humain qui tape tres vite. Nous n'utilisons jamais d'API privee et n'automatisons ni likes ni follows. Zero action de masse.",
      safetyStatBotRiskLabel: "Risque de ban",
      safetyStatBotRiskNote: "Signale par des vendeurs en quelques semaines",
      safetyStatAlRiskLabel: "Risque AutoLister",
      safetyStatAlRiskNote: "0 action de masse. 0 acces API.",
      safetyFeature1Title: "Pas d'acces API",
      safetyFeature1Body: "Nous ne touchons jamais au code interne de Vinted — zero declenchement Cloudflare.",
      safetyFeature2Title: "Rythme humain",
      safetyFeature2Body: "Nous remplissons les champs a votre place — comme un dactylo tres rapide. Aucune action de masse.",
      safetyFeature3Title: "Votre portefeuille reste en securite",
      safetyFeature3Body: "Vous relisez chaque annonce avant publication. Votre compte et portefeuille Vinted ne sont jamais en danger.",
      comparisonBadge: "Comparaison honnete",
      comparisonBotSubtitle: "Bots d'automatisation Vinted",
      comparisonAlSubtitle: "Generateur de contenu IA",
      comparisonSafeChoice: "Choix sur",
      comparisonBotBullet1Title: "Risque eleve de bannissement",
      comparisonBotBullet1Body: "Se connectent a l'API privee de Vinted — des bans signales en quelques semaines",
      comparisonBotBullet2Title: "Declenchement detection Cloudflare",
      comparisonBotBullet2Body: "500 auto-likes et auto-follows par jour marquent votre compte comme automatise",
      comparisonBotBullet3Title: "Violation des CGU de Vinted",
      comparisonBotBullet3Body: "L'automatisation via API privee est explicitement interdite par les CGU Vinted",
      comparisonBotBullet4Title: "Votre portefeuille Vinted en danger",
      comparisonBotBullet4Body: "Bannissement = portefeuille gele. Tout l'argent sur la plateforme peut etre bloque instantanement",
      comparisonAlBullet1Title: "Zero risque de ban",
      comparisonAlBullet1Body: "Lit votre photo, redige votre annonce — comportement identique a un vendeur humain",
      comparisonAlBullet2Title: "Zero declenchement Cloudflare",
      comparisonAlBullet2Body: "Aucun appel API prive. Aucune action de masse. Totalement invisible pour la detection de bots.",
      comparisonAlBullet3Title: "100% conforme aux CGU Vinted",
      comparisonAlBullet3Body: "Un assistant de redaction, pas un bot. Aide a creer de meilleures annonces dans le respect des regles.",
      comparisonAlBullet4Title: "Votre portefeuille reste protege",
      comparisonAlBullet4Body: "Aucun risque de compte, aucun fonds gele. Listez plus, stressez moins.",
      comparisonFootnote: "Comparaison basee sur les fonctionnalites publiquement adverties de DotB et Vintex en 2025. AutoLister AI n'est pas affilie a Vinted.",
      featuresTitle: "Une facon plus rapide de vendre sur Vinted",
      featuresSubtitle: "Photo. Analyse. Vente. Passez de votre galerie a une annonce Vinted en quelques secondes.",
      feature1Title: "Optimise pour la conversion",
      feature1Body: "Chaque titre et description est redige pour maximiser l'attrait et stimuler les ventes.",
      feature2Title: "Integration fluide",
      feature2Body: "Fini les excuses. De la photo a l'annonce publiee, le flux est entierement fluide.",
      feature3Title: "Technologie IA intelligente",
      feature3Body: "Propulse par des modeles de langage avances qui comprennent la mode et les pratiques Vinted.",
      howItWorksTitle: "Comment ca marche",
      howItWorksSubtitle: "Des annonces pro en trois etapes simples",
      step1Title: "Installez l'extension",
      step1Body: "Ajoutez le generateur Vinted a votre navigateur en quelques secondes. C'est gratuit.",
      step2Title: "Ajoutez des photos et generez",
      step2Body: "Ajoutez vos photos puis cliquez sur Generer pour obtenir une annonce optimisee.",
      step3Title: "Publiez et vendez",
      step3Body: "Revisez, ajustez si besoin, puis publiez votre annonce optimisee.",
      finalCtaTitle: "Pret a booster vos ventes Vinted ?",
      finalCtaBody: "Rejoignez des milliers de vendeurs qui utilisent AutoLister pour vendre plus vite.",
      getStartedFree: "Commencer gratuitement",
    },
    pricing: {
      safetyBannerTitle: "Le seul outil Vinted vraiment sur pour votre compte.",
      safetyZeroMass: "0 action de masse",
      safetyZeroApi: "0 acces API",
      safetyZeroBan: "0 risque de ban",
      accountSafe: "Securise",
      mostPopular: "Le plus populaire",
      perMonth: "/mois",
      perForever: "/a vie",
      freePlanName: "Essai gratuit",
      freePlanSubtitle: "Decouvrez AutoLister AI",
      ...
      aiGeneratedTitles: "Titres et descriptions generes par IA",
      phoneUpload: "Photo depuis mobile (bientot reserve Pro et Business)",
      seeIfYouLikeIt: "Testez avant de vous engager",
      everythingInStarter: "Tout ce qu'inclut Starter",
      changeAiTone: "Changer le ton de redaction IA",
      ...
      dedicatedSupport: "Support dedie",
      priorityProcessing: "Traitement prioritaire",
      noCard: "Aucune carte bancaire requise",
      instantAccess: "Acces immediat aux fonctions gratuites.",
  ...
  de: {
    home: {
      ...
      heroBullet1: "Erstellt SEO-optimierte Titel, Beschreibungen und Hashtags automatisch",
      ...
      safetyBody: "Anders als DotB und Vintex — die sich in Vinteds private API einklinken — arbeitet AutoLister rein als Browser-Produktivitatswerkzeug. Es schreibt Text fur dich. Nichts weiter.",
      ...
      safetyCoreSubtitle: "Das Risiko ist die Automatisierung von Aktionen auf Vinted.",
      safetyCoreBody: "AutoLister verhallt sich wie ein Mensch, der sehr schnell tippt. Wir nutzen keine privaten APIs und automatisieren keine Likes oder Follows. Null Massenaktionen.",
      ...
      safetyFeature1Body: "Wir beruhren niemals Vinteds internen Code oder private Endpunkte — null Cloudflare-Trigger.",
      safetyFeature2Title: "Menschliches Tempo",
      safetyFeature2Body: "Wir fullen Textfelder fur dich — wie ein sehr schneller Tippist. Keine Massenaktionen, keine Spam-Schleifen.",
      safetyFeature3Title: "Dein Guthaben bleibt sicher",
      safetyFeature3Body: "Du prufst jede Anzeige bevor sie live geht. Dein Vinted-Guthaben und Konto sind niemals in Gefahr.",
      ...
      comparisonBotBullet1Body: "Klinken sich in Vinteds private API ein — Community berichtet von Bans innerhalb von Wochen",
      comparisonBotBullet2Title: "Cloudflare-Bot-Erkennung ausgelost",
      comparisonBotBullet2Body: "500 tagliche Auto-Likes und Auto-Follows markieren dein Konto als automatisierten Traffic",
      comparisonBotBullet3Title: "Verstost gegen Vinteds Nutzungsbedingungen",
      comparisonBotBullet3Body: "Die Automatisierung uber private API ist explizit in Vinteds AGB verboten",
      comparisonBotBullet4Title: "Dein Vinted-Guthaben in Gefahr",
      comparisonBotBullet4Body: "Konto-Ban = Guthaben eingefroren. Jedes Geld auf der Plattform konnte sofort gesperrt werden",
      comparisonAlBullet1Title: "Null Bannrisiko",
      comparisonAlBullet1Body: "Liest dein Foto, schreibt deinen Anzeigentext — identisches Verhalten wie ein menschlicher Verkaufer",
      comparisonAlBullet2Title: "Null Cloudflare-Trigger",
      comparisonAlBullet2Body: "Keine privaten API-Aufrufe. Keine Massenaktionen. Vollig unsichtbar fur Bot-Erkennung.",
      comparisonAlBullet3Title: "100% Vinted-AGB-konform",
      comparisonAlBullet3Body: "Ein Schreibassistent, kein Bot. Hilft dir bessere Anzeigen zu erstellen, vollstandig nach Regeln.",
      comparisonAlBullet4Title: "Dein Guthaben bleibt geschutzt",
      comparisonAlBullet4Body: "Kein Kontorisiko, keine gesperrten Mittel. Mehr inserieren, weniger sorgen.",
      comparisonFootnote: "Vergleich basiert auf offentlich beworbenen Funktionen von DotB und Vintex Stand 2025. AutoLister AI ist nicht mit Vinted verbunden.",
      featuresTitle: "Schneller auf Vinted verkaufen",
      featuresSubtitle: "Foto. Analyse. Verkauf. Von der Galerie zur fertigen Vinted-Anzeige in Sekunden.",
      feature1Title: "Conversion-Optimiert",
      feature1Body: "Jeder Titel und jede Beschreibung ist darauf ausgelegt, Kaufinteresse zu maximieren und Verkaufe zu steigern.",
      feature2Title: "Nahtloser Ablauf",
      feature2Body: "Keine Ausreden mehr. Von der Foto bis zur Veroffentlichung lauft alles nahtlos.",
      feature3Title: "Intelligente KI-Technologie",
      feature3Body: "Angetrieben von fortschrittlichen Sprachmodellen, die Modetrends und Vinted-Best-Practices verstehen.",
      howItWorksTitle: "So funktioniert's",
      howItWorksSubtitle: "Professionelle Anzeigen in drei einfachen Schritten",
      step1Title: "Erweiterung installieren",
      step1Body: "Fuge den Vinted-Generator in Sekunden deinem Browser hinzu. Kostenloser Start.",
      step2Title: "Fotos hinzufugen und generieren",
      step2Body: "Fotos hochladen und auf Generieren klicken. AutoLister erstellt den optimierten Text.",
      step3Title: "Veroffentlichen und verkaufen",
      step3Body: "Prufen, anpassen und veroffentlichen. So verkaufst du schneller.",
      finalCtaTitle: "Bereit, deine Vinted-Verkaufe zu steigern?",
      finalCtaBody: "Tausende Seller nutzen AutoLister fur professionelle Anzeigen, die schneller verkaufen.",
      getStartedFree: "Kostenlos starten",
    },
    pricing: {
      safetyBannerTitle: "Das einzige Vinted-Tool, das dein Konto wirklich schutzt.",
  ...
  nl: {
    home: {
      ...
      heroBullet1: "Genereert automatisch SEO-klare titels, beschrijvingen en hashtags",
      ...
      safetyBody: "In tegenstelling tot DotB en Vintex — die zich koppelen aan Vinteds prive-API — werkt AutoLister puur als een browser-productiviteitstool. Het schrijft tekst voor jou. Niets meer.",
      safetyNativeBadge: "100% native browser-extensie",
      safetyCoreBadge: "Het kernverschil",
      safetyCoreTitle: "Het risico is niet AI.",
      safetyCoreSubtitle: "Het risico is het automatiseren van acties op Vinted.",
      safetyCoreBody: "AutoLister gedraagt zich precies als een mens die heel snel typt. We gebruiken geen prive-API's en automatiseren geen likes of follows. Nul massa-acties.",
      ...
      safetyFeature1Body: "We raken nooit Vinteds interne code of prive-endpoints aan — nul Cloudflare-triggers.",
      safetyFeature2Title: "Menselijk tempo",
      safetyFeature2Body: "We vullen tekstvelden voor jou in — als een heel snelle typist. Geen massa-acties, geen spam-loops.",
      safetyFeature3Title: "Je saldo blijft veilig",
      safetyFeature3Body: "Je controleert elke listing voor publicatie. Je Vinted-saldo en account zijn nooit in gevaar.",
      ...
      comparisonBotBullet1Body: "Koppelen aan Vinteds prive-API — bans gemeld door de community binnen weken van gebruik",
      comparisonBotBullet2Title: "Cloudflare-botdetectie getriggerd",
      comparisonBotBullet2Body: "500 dagelijkse auto-likes en auto-follows markeren je account als geautomatiseerd verkeer",
      comparisonBotBullet3Title: "Schendt Vinteds gebruiksvoorwaarden",
      comparisonBotBullet3Body: "Automatisering via prive-API is uitdrukkelijk verboden in de Vinted-voorwaarden",
      comparisonBotBullet4Title: "Je Vinted-saldo in gevaar",
      comparisonBotBullet4Body: "Account-ban = saldo bevroren. Al het geld op het platform kan direct worden geblokkeerd",
      comparisonAlBullet1Title: "Nul banrisico",
      comparisonAlBullet1Body: "Leest je foto, schrijft je listingtekst — identiek gedrag als een menselijke verkoper",
      comparisonAlBullet2Title: "Nul Cloudflare-triggers",
      comparisonAlBullet2Body: "Geen prive-API-aanroepen. Geen massa-acties. Volledig onzichtbaar voor botdetectie.",
      comparisonAlBullet3Title: "100% conform Vinted-voorwaarden",
      comparisonAlBullet3Body: "Een schrijfassistent, geen bot. Helpt je betere listings te maken, volledig binnen de regels.",
      comparisonAlBullet4Title: "Je saldo blijft beschermd",
      comparisonAlBullet4Body: "Geen accountrisico, geen bevroren fondsen. Meer listen, minder zorgen.",
      comparisonFootnote: "Vergelijking gebaseerd op publiek geadverteerde functies van DotB en Vintex per 2025. AutoLister AI is niet gelieerd aan Vinted.",
      featuresTitle: "Sneller verkopen op Vinted",
      featuresSubtitle: "Foto. Scan. Verkoop. Van je camera-rol naar een Vinted listing in seconden.",
      feature1Title: "Conversie-Geoptimaliseerd",
      feature1Body: "Elke titel en beschrijving is gemaakt om aantrekkelijkheid te maximaliseren en verkopen te stimuleren.",
      feature2Title: "Naadloze Workflow",
      feature2Body: "Geen excuses meer. Van foto tot gepubliceerde listing verloopt alles naadloos.",
      feature3Title: "Slimme AI-technologie",
      feature3Body: "Aangedreven door geavanceerde taalmodellen die modetrends en Vinted-best practices begrijpen.",
      howItWorksTitle: "Hoe het werkt",
      howItWorksSubtitle: "Professionele listings in drie eenvoudige stappen",
      step1Title: "Installeer de extensie",
      step1Body: "Voeg de Vinted-generator in seconden toe aan je browser. Gratis starten.",
      step2Title: "Voeg foto's toe en genereer",
      step2Body: "Upload foto's en klik op Genereren voor direct geoptimaliseerde listingtekst.",
      step3Title: "Publiceer en verkoop",
      step3Body: "Controleer, pas aan en publiceer. Verkoop sneller met minder werk.",
      finalCtaTitle: "Klaar om je Vinted-verkoop te versnellen?",
      finalCtaBody: "Sluit je aan bij duizenden verkopers die AutoLister gebruiken om sneller te verkopen.",
      getStartedFree: "Gratis beginnen",
    },
    pricing: {
      safetyBannerTitle: "De enige Vinted-tool die je account echt veilig houdt.",
      ...
      phoneUpload: "Foto-upload via telefoon (binnenkort alleen Pro en Business)",
  ...
  pl: {
    home: {
      ...
      heroBullet1: "Automatycznie generuje tytuly, opisy i hashtagi zoptymalizowane pod SEO",
      ...
      safetyBody: "W przeciwienstwie do DotB i Vintex — ktore lacza sie z prywatnym API Vinted — AutoLister dziala wylacznie jako narzedzie produktywnosci. Pisze dla Ciebie tekst. Nic wiecej.",
      ...
      safetyCoreBody: "AutoLister dziala jak czlowiek, ktory bardzo szybko pisze. Nie korzystamy z prywatnych API i nie automatyzujemy polubien ani obserwacji. Zero akcji masowych.",
      safetyStatBotRiskLabel: "Ryzyko bana bota",
      safetyStatBotRiskNote: "Zglaszane przez sprzedawcow w ciagu kilku tygodni",
      ...
      safetyFeature1Body: "Nigdy nie dotykamy wewnetrznego kodu Vinted ani prywatnych endpointow — zero wyzwalan Cloudflare.",
      safetyFeature2Title: "Ludzkie tempo",
      safetyFeature2Body: "Wypelniamy za Ciebie pola tekstowe — jak bardzo szybki maszynista. Bez akcji masowych, bez petli spamu.",
      safetyFeature3Title: "Twoj portfel pozostaje bezpieczny",
      safetyFeature3Body: "Przegladsz kazde ogloszenie przed publikacja. Twoj portfel Vinted i konto nigdy nie sa zagrozone.",
      ...
      comparisonBotBullet1Body: "Lacza sie z prywatnym API Vinted — spolecznosc zglosila bany juz po kilku tygodniach",
      comparisonBotBullet2Title: "Wyzwolenie wykrywania botow Cloudflare",
      comparisonBotBullet2Body: "500 dziennych auto-polubien i auto-obserwacji oznacza Twoje konto jako automatyczny ruch",
      comparisonBotBullet3Title: "Narusza regulamin Vinted",
      comparisonBotBullet3Body: "Automatyzacja via prywatne API jest wyraznie zabroniona w regulaminie Vinted",
      comparisonBotBullet4Title: "Twoj portfel Vinted jest zagrozony",
      comparisonBotBullet4Body: "Ban konta = zamrozony portfel. Kazde pieniadze na platformie moga byc zablokowane natychmiast",
      comparisonAlBullet1Title: "Zero ryzyka bana",
      comparisonAlBullet1Body: "Odczytuje Twoje zdjecie, pisze tekst ogloszenia — zachowanie identyczne z ludzkim sprzedawca",
      comparisonAlBullet2Title: "Zero wyzwalan Cloudflare",
      comparisonAlBullet2Body: "Brak prywatnych wywolan API. Brak akcji masowych. Calkowicie niewidoczny dla wykrywania botow.",
      comparisonAlBullet3Title: "100% zgodny z regulaminem Vinted",
      comparisonAlBullet3Body: "Asystent pisania, nie bot. Pomaga tworzyc lepsze ogloszenia, w pelni zgodnie z zasadami.",
      comparisonAlBullet4Title: "Twoj portfel pozostaje chroniony",
      comparisonAlBullet4Body: "Brak ryzyka konta, brak zamrozonych srodkow. Wiecej sprzedawaj, mniej sie martw.",
      comparisonFootnote: "Porownanie oparte na publicznie reklamowanych funkcjach DotB i Vintex z 2025 roku. AutoLister AI nie jest powiazany z Vinted.",
      featuresTitle: "Szybsza sprzedaz na Vinted",
      featuresSubtitle: "Zdjecie. Analiza. Sprzedaz. Od galerii do gotowego ogloszenia Vinted w kilka sekund.",
      feature1Title: "Zoptymalizowane pod konwersje",
      feature1Body: "Kazdy tytul i opis jest stworzony tak, aby maksymalizowac atrakcyjnosc i napedzac sprzedaz.",
      feature2Title: "Plynna praca",
      feature2Body: "Nie ma juz wymowek. Od zdjecia do opublikowanego ogloszenia — wszystko plynnie.",
      feature3Title: "Inteligentna technologia AI",
      feature3Body: "Zasilany zaawansowanymi modelami jezykowymi rozumiejacymi trendy mody i najlepsze praktyki Vinted.",
      ...
      step1Body: "Dodaj generator Vinted do przegladarki w kilka sekund. Start jest darmowy.",
      step2Title: "Dodaj zdjecia i generuj",
      step2Body: "Wgraj zdjecia i kliknij Generuj, aby od razu otrzymac zoptymalizowany opis.",
      step3Title: "Publikuj i sprzedawaj",
      step3Body: "Sprawdz, popraw i opublikuj. Sprzedawaj szybciej przy mniejszym wysilku.",
      finalCtaTitle: "Gotowy zwiekszyc sprzedaz na Vinted?",
      finalCtaBody: "Dolacz do tysiecy sprzedawcow, ktorzy uzywaja AutoLister do szybszej sprzedazy.",
      getStartedFree: "Zacznij za darmo",
    },
    pricing: {
      safetyBannerTitle: "Jedyne narzedzie Vinted, ktore naprawde chroni Twoje konto.",
  ...
  es: {
    home: {
      ...
      heroBullet1: "Genera titulos, descripciones y hashtags optimizados para SEO automaticamente",
      ...
      safetyBody: "A diferencia de DotB y Vintex — que se conectan a la API privada de Vinted para auto-seguir y auto-dar likes — AutoLister funciona estrictamente como una herramienta de productividad del navegador. Escribe texto por ti. Nada mas.",
      ...
      safetyCoreBody: "AutoLister actua exactamente como un humano escribiendo muy rapido. Nunca tocamos APIs privadas ni automatizamos likes o follows. Cero acciones masivas.",
      ...
      safetyFeature1Body: "Nunca tocamos el codigo interno de Vinted ni endpoints privados — cero activacion de Cloudflare.",
      safetyFeature2Title: "Ritmo humano",
      safetyFeature2Body: "Rellenamos los campos de texto por ti — como un mecanografo muy rapido. Sin acciones masivas, sin bucles de spam.",
      safetyFeature3Title: "Tu cartera esta segura",
      safetyFeature3Body: "Revisas cada anuncio antes de publicarlo. Tu cartera y cuenta de Vinted nunca estan en riesgo.",
      ...
      comparisonBotBullet1Body: "Se conectan a la API privada de Vinted — bans reportados en la comunidad a las pocas semanas",
      comparisonBotBullet2Title: "Activacion de deteccion de bots Cloudflare",
      comparisonBotBullet2Body: "500 auto-likes y auto-follows diarios marcan tu cuenta como trafico automatizado",
      comparisonBotBullet3Title: "Viola los Terminos de Servicio de Vinted",
      comparisonBotBullet3Body: "Automatizar acciones de Vinted via API privada esta expresamente prohibido en sus ToS",
      comparisonBotBullet4Title: "Tu cartera de Vinted en riesgo",
      comparisonBotBullet4Body: "Baneo de cuenta = cartera congelada. Cualquier dinero en la plataforma podria bloquearse al instante",
      comparisonAlBullet1Title: "Cero riesgo de baneo",
      comparisonAlBullet1Body: "Lee tu foto, escribe el texto del anuncio — comportamiento identico al de un vendedor humano",
      comparisonAlBullet2Title: "Cero activaciones de Cloudflare",
      comparisonAlBullet2Body: "Sin llamadas privadas a la API. Sin acciones masivas. Completamente invisible para la deteccion de bots.",
      comparisonAlBullet3Title: "100% conforme con los ToS de Vinted",
      comparisonAlBullet3Body: "Un asistente de escritura, no un bot. Ayuda a crear mejores anuncios totalmente dentro de las reglas.",
      comparisonAlBullet4Title: "Tu cartera permanece protegida",
      comparisonAlBullet4Body: "Sin riesgo de cuenta, sin fondos congelados. Anuncia mas, preocupate menos.",
      comparisonFootnote: "Comparacion basada en las funciones publicamente anunciadas de DotB y Vintex a partir de 2025. AutoLister AI no esta afiliado ni respaldado por Vinted.",
      featuresTitle: "Una forma mas rapida de vender en Vinted",
      featuresSubtitle: "Foto. Analiza. Vende. De tu galeria a un anuncio de Vinted en segundos.",
      feature1Title: "Optimizado para Conversion",
      feature1Body: "Cada titulo y descripcion esta elaborado para maximizar el atractivo y generar ventas.",
      feature2Title: "Flujo de Trabajo Sin Fricciones",
      feature2Body: "Sin excusas para no vender. De la foto al anuncio publicado, todo fluye a la perfeccion.",
      feature3Title: "Tecnologia IA Inteligente",
      feature3Body: "Impulsado por modelos de lenguaje avanzados que entienden tendencias de moda y mejores practicas de Vinted.",
      howItWorksTitle: "Como funciona",
      howItWorksSubtitle: "Anuncios profesionales en tres pasos simples",
      step1Title: "Instala la extension",
      step1Body: "Anade el generador de Vinted a tu navegador en segundos. Es gratis para empezar.",
      step2Title: "Sube fotos y genera",
      step2Body: "Sube tus fotos y pulsa Generar para obtener texto optimizado al instante.",
      step3Title: "Publica y vende",
      step3Body: "Revisa, ajusta si quieres y publica. Vende mas rapido con menos esfuerzo.",
      finalCtaTitle: "Listo para acelerar tus ventas en Vinted?",
      finalCtaBody: "Unete a miles de vendedores que usan AutoLister para vender mas rapido.",
      getStartedFree: "Empieza gratis",
    },
    pricing: {
      safetyBannerTitle: "La unica herramienta de Vinted que protege de verdad tu cuenta.",
  ...
  it: {
    home: {
      ...
      heroBullet1: "Genera automaticamente titoli, descrizioni e hashtag ottimizzati per il SEO",
      ...
      safetyBody: "A differenza di DotB e Vintex — che si collegano all'API privata di Vinted per auto-seguire e auto-mettere like — AutoLister opera strettamente come uno strumento di produttivita del browser. Scrive testo per te. Nient'altro.",
      ...
      safetyCoreBody: "AutoLister si comporta esattamente come un umano che scrive molto velocemente. Non tocchiamo API private e non automatizziamo likes o follows. Zero azioni di massa.",
      ...
      safetyFeature1Body: "Non tocchiamo mai il codice interno di Vinted o endpoint privati — zero trigger Cloudflare.",
      safetyFeature2Title: "Ritmo umano",
      safetyFeature2Body: "Compiliamo i campi di testo per te — come un dattilografo molto veloce. Nessuna azione di massa, nessun loop di spam.",
      safetyFeature3Title: "Il tuo portafoglio e al sicuro",
      safetyFeature3Body: "Revisioni ogni annuncio prima che vada in linea. Il tuo portafoglio e account Vinted non sono mai a rischio.",
      ...
      comparisonBotBullet1Body: "Si collegano all'API privata di Vinted — la community segnala ban entro settimane dall'uso",
      comparisonBotBullet2Title: "Rilevamento bot Cloudflare attivato",
      comparisonBotBullet2Body: "500 auto-like e auto-follow giornalieri contrassegnano il tuo account come traffico automatizzato",
      comparisonBotBullet3Title: "Viola i Termini di Servizio di Vinted",
      comparisonBotBullet3Body: "Automatizzare le azioni di Vinted tramite API privata e esplicitamente vietato nei loro ToS",
      comparisonBotBullet4Title: "Il tuo portafoglio Vinted a rischio",
      comparisonBotBullet4Body: "Ban account = portafoglio congelato. Qualsiasi denaro sulla piattaforma potrebbe essere bloccato istantaneamente",
      comparisonAlBullet1Title: "Zero rischio di ban",
      comparisonAlBullet1Body: "Legge la tua foto, scrive il testo dell'annuncio — comportamento identico a un venditore umano",
      comparisonAlBullet2Title: "Zero trigger Cloudflare",
      comparisonAlBullet2Body: "Nessuna chiamata API privata. Nessuna azione di massa. Completamente invisibile al rilevamento bot.",
      comparisonAlBullet3Title: "100% conforme ai ToS di Vinted",
      comparisonAlBullet3Body: "Un assistente di scrittura, non un bot. Aiuta a creare annunci migliori, completamente nel rispetto delle regole.",
      comparisonAlBullet4Title: "Il tuo portafoglio resta protetto",
      comparisonAlBullet4Body: "Nessun rischio account, nessun fondo congelato. Pubblica di piu, preoccupati di meno.",
      comparisonFootnote: "Confronto basato sulle funzionalita pubblicamente pubblicizzate di DotB e Vintex al 2025. AutoLister AI non e affiliato ne approvato da Vinted.",
      featuresTitle: "Un modo piu veloce di vendere su Vinted",
      featuresSubtitle: "Scatta. Analizza. Vendi. Dalla galleria a un annuncio Vinted in pochi secondi.",
      feature1Title: "Ottimizzato per la Conversione",
      feature1Body: "Ogni titolo e descrizione e scritto per massimizzare l'attrattiva e generare vendite.",
      feature2Title: "Flusso di Lavoro Senza Intoppi",
      feature2Body: "Nessuna scusa per non vendere. Dalla foto all'annuncio pubblicato, tutto scorre perfettamente.",
      feature3Title: "Tecnologia AI Intelligente",
      feature3Body: "Alimentato da modelli linguistici avanzati che comprendono tendenze della moda e best practice di Vinted.",
      howItWorksTitle: "Come funziona",
      howItWorksSubtitle: "Annunci professionali in tre passaggi semplici",
      step1Title: "Installa l'estensione",
      step1Body: "Aggiungi il generatore Vinted al browser in pochi secondi. Inizio gratuito.",
      step2Title: "Aggiungi foto e genera",
      step2Body: "Carica le foto e clicca Genera per ottenere subito testi ottimizzati.",
      step3Title: "Pubblica e vendi",
      step3Body: "Controlla, modifica se vuoi e pubblica. Vendi piu velocemente con meno fatica.",
      finalCtaTitle: "Pronto ad aumentare le vendite su Vinted?",
      finalCtaBody: "Unisciti a migliaia di venditori che usano AutoLister per vendere piu rapidamente.",
      getStartedFree: "Inizia gratis",
    },
    pricing: {
      safetyBannerTitle: "L'unico strumento Vinted che protegge davvero il tuo account.",
  ...
  pt: {
    home: {
      ...
      heroBullet1: "Gera automaticamente titulos, descricoes e hashtags otimizados para SEO",
      ...
      safetyBody: "Ao contrario do DotB e Vintex — que se ligam a API privada da Vinted para auto-seguir e auto-dar gostos — o AutoLister funciona estritamente como uma ferramenta de produtividade do navegador. Escreve texto por si. Nada mais.",
      ...
      safetyCoreBody: "O AutoLister comporta-se exatamente como um humano a escrever muito depressa. Nunca tocamos em APIs privadas nem automatizamos gostos ou follows. Zero acoes em massa.",
      ...
      safetyFeature1Body: "Nunca tocamos no codigo interno da Vinted ou endpoints privados — zero ativacoes Cloudflare.",
      safetyFeature2Title: "Ritmo humano",
      safetyFeature2Body: "Preenchemos os campos de texto por si — como um datilografo muito rapido. Sem acoes em massa, sem loops de spam.",
      safetyFeature3Title: "A sua carteira esta segura",
      safetyFeature3Body: "Reveja cada anuncio antes de publicar. A sua carteira e conta Vinted nunca estao em risco.",
      ...
      comparisonBotBullet1Body: "Ligam-se a API privada da Vinted — comunidade reporta bans em poucas semanas de uso",
      comparisonBotBullet2Title: "Detecao de bots Cloudflare ativada",
      comparisonBotBullet2Body: "500 auto-gostos e auto-seguidores diarios marcam a sua conta como trafego automatizado",
      comparisonBotBullet3Title: "Viola os Termos de Servico da Vinted",
      comparisonBotBullet3Body: "Automatizar acoes da Vinted via API privada e explicitamente proibido nos seus ToS",
      comparisonBotBullet4Title: "A sua carteira Vinted em risco",
      comparisonBotBullet4Body: "Ban da conta = carteira congelada. Qualquer dinheiro na plataforma pode ser bloqueado instantaneamente",
      comparisonAlBullet1Title: "Zero risco de ban",
      comparisonAlBullet1Body: "Le a sua foto, escreve o texto do anuncio — comportamento identico ao de um vendedor humano",
      comparisonAlBullet2Title: "Zero ativacoes Cloudflare",
      comparisonAlBullet2Body: "Sem chamadas privadas a API. Sem acoes em massa. Completamente invisivel para detetar bots.",
      comparisonAlBullet3Title: "100% conforme com os ToS da Vinted",
      comparisonAlBullet3Body: "Um assistente de escrita, nao um bot. Ajuda a criar melhores anuncios, totalmente dentro das regras.",
      comparisonAlBullet4Title: "A sua carteira permanece protegida",
      comparisonAlBullet4Body: "Sem risco de conta, sem fundos congelados. Publique mais, preocupe-se menos.",
      comparisonFootnote: "Comparacao baseada nas funcionalidades publicamente anunciadas do DotB e Vintex ate 2025. O AutoLister AI nao e afiliado nem apoiado pela Vinted.",
      featuresTitle: "Uma forma mais rapida de vender na Vinted",
      featuresSubtitle: "Foto. Analise. Venda. Da galeria para um anuncio Vinted em segundos.",
      feature1Title: "Otimizado para Conversao",
      feature1Body: "Cada titulo e descricao e elaborado para maximizar o apelo e gerar mais vendas.",
      feature2Title: "Fluxo de Trabalho Fluido",
      feature2Body: "Sem desculpas para nao vender. Da foto ao anuncio publicado, tudo acontece sem fricao.",
      feature3Title: "Tecnologia IA Inteligente",
      feature3Body: "Impulsionado por modelos de linguagem avancados que compreendem tendencias de moda e melhores praticas Vinted.",
      howItWorksTitle: "Como funciona",
      howItWorksSubtitle: "Anuncios profissionais em tres passos simples",
      step1Title: "Instale a extensao",
      step1Body: "Adicione o gerador Vinted ao navegador em segundos. E gratis para comecar.",
      step2Title: "Adicione fotos e gere",
      step2Body: "Carregue as fotos e clique em Gerar para obter texto otimizado de imediato.",
      step3Title: "Publique e venda",
      step3Body: "Reveja, ajuste se quiser e publique. Venda mais rapido com menos trabalho.",
      finalCtaTitle: "Pronto para acelerar as suas vendas na Vinted?",
      finalCtaBody: "Junte-se a milhares de vendedores que usam o AutoLister para vender mais rapido.",
      getStartedFree: "Comecar gratis",
    },
    pricing: {
      safetyBannerTitle: "A unica ferramenta Vinted que protege mesmo a sua conta.",
