...
> = {
  ...
  fr: {
    home: {
      ...
      heroBullet1:
        "Genere des titres, descriptions et hashtags SEO automatiquement",
      ...
      safetyBody:
        "Contrairement a DotB et Vintex — qui se connectent a l'API privee de Vinted — AutoLister est un simple outil de redaction. Il ecrit du texte pour vous. Rien de plus.",
      ...
      safetyCoreBody:
        "AutoLister agit comme un humain qui tape tres vite. Nous n'utilisons jamais d'API privee et n'automatisons ni likes ni follows. Zero action de masse.",
      ...
      safetyFeature1Body:
        "Nous ne touchons jamais au code interne de Vinted — zero declenchement Cloudflare.",
      safetyFeature2Title: "Rythme humain",
      safetyFeature2Body:
        "Nous remplissons les champs a votre place — comme un dactylo tres rapide. Aucune action de masse.",
      ...
      comparisonBotBullet1Body:
        "Se connectent a l'API privee de Vinted — des bans signales en quelques semaines",
      comparisonBotBullet2Title: "Declenchement detection Cloudflare",
      comparisonBotBullet2Body:
        "500 auto-likes et auto-follows par jour marquent votre compte comme automatise",
      comparisonBotBullet3Title: "Violation des CGU de Vinted",
      comparisonBotBullet3Body:
        "L'automatisation via API privee est explicitement interdite par les CGU Vinted",
      comparisonBotBullet4Title: "Votre portefeuille Vinted en danger",
      comparisonBotBullet4Body:
        "Bannissement = portefeuille gele. Tout l'argent sur la plateforme peut etre bloque instantanement",
      comparisonAlBullet1Title: "Zero risque de ban",
      comparisonAlBullet1Body:
        "Lit votre photo, redige votre annonce — comportement identique a un vendeur humain",
      comparisonAlBullet2Title: "Zero declenchement Cloudflare",
      comparisonAlBullet2Body:
        "Aucun appel API prive. Aucune action de masse. Totalement invisible pour la detection de bots.",
      comparisonAlBullet3Title: "100% conforme aux CGU Vinted",
      comparisonAlBullet3Body:
        "Un assistant de redaction, pas un bot. Aide a creer de meilleures annonces dans le respect des regles.",
      comparisonAlBullet4Title: "Votre portefeuille reste protege",
      comparisonAlBullet4Body:
        "Aucun risque de compte, aucun fonds gele. Listez plus, stressez moins.",
      comparisonFootnote:
        "Comparaison basee sur les fonctionnalites publiquement adverties de DotB et Vintex en 2025. AutoLister AI n'est pas affilie a Vinted.",
      featuresTitle: "Une facon plus rapide de vendre sur Vinted",
      featuresSubtitle:
        "Photo. Analyse. Vente. Passez de votre galerie a une annonce Vinted en quelques secondes.",
      feature1Title: "Optimise pour la conversion",
      feature1Body:
        "Chaque titre et description est redige pour maximiser l'attrait et stimuler les ventes.",
      feature2Title: "Integration fluide",
      feature2Body:
        "Fini les excuses. De la photo a l'annonce publiee, le flux est entierement fluide.",
      feature3Title: "Technologie IA intelligente",
      feature3Body:
        "Propulse par des modeles de langage avances qui comprennent la mode et les pratiques Vinted.",
      ...
      step1Body:
        "Ajoutez le generateur Vinted a votre navigateur en quelques secondes. C'est gratuit.",
      step2Title: "Ajoutez des photos et generez",
      step2Body:
        "Ajoutez vos photos puis cliquez sur Generer pour obtenir une annonce optimisee.",
      step3Title: "Publiez et vendez",
      step3Body:
        "Revisez, ajustez si besoin, puis publiez votre annonce optimisee.",
