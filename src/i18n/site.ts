...
> = {
  en: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "For growing sellers",
      ...
      forVintedProSellers: "For Vinted Pro sellers",
      packBarTitle: "Closet Clear Pack",
      packBarDesc: "15 credits that never expire. No commitment. Perfect for clearing your closet.",
      packBarCta: "Buy Pack",
    },
  },
  fr: {
    ...
    pricing: {
      ...
      freeTagline: "Commencez gratuitement avec 13 crédits — sans carte bancaire.",
      creditsPerMonth: "crédits/mois",
      perCredit: "/crédit",
      subscribeCta: "S'abonner",
      plusPlanName: "Plus",
      plusPlanSubtitle: "Pour les vendeurs en croissance",
      ...
      packBarDesc: "15 crédits qui n'expirent jamais. Sans engagement. Parfait pour vider votre dressing.",
  ...
  de: {
    ...
    pricing: {
      ...
      freeTagline: "Starte kostenlos mit 13 Credits — keine Karte notig.",
      creditsPerMonth: "Credits/Monat",
      perCredit: "/Credit",
      subscribeCta: "Abonnieren",
      plusPlanName: "Plus",
      plusPlanSubtitle: "Fur wachsende Verkaufer",
      phoneUploadUnlimited: "Foto-Upload vom Handy (unbegrenzt)",
      creditRolloverFeature: "Credits werden ubertragen — bis zu",
      listingCompleteness: "Vollstandigkeits-Score fur Anzeigen",
      standardSupport: "Standard-Support",
      listingPreferences: "Anzeigenpraferenzen und Stil",
      ...
      prioritySupport24h: "Prioritats-Support (24h)",
      forVintedProSellers: "Fur Vinted Pro-Verkaufer",
      packBarTitle: "Kleiderschrank-Raumungspaket",
      packBarDesc: "15 Credits, die niemals verfallen. Keine Bindung. Perfekt zum Ausraumen deines Kleiderschranks.",
  ...
  nl: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "Voor groeiende verkopers",
      ...
      packBarDesc: "15 credits die nooit verlopen. Geen verplichting. Perfect voor het opruimen van je kledingkast.",
  ...
  pl: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "Dla rozwijajacych sie sprzedawcow",
      ...
      packBarDesc: "15 kredytow, ktore nigdy nie wygasaja. Bez zobowiazan. Idealny do oprozniania szafy.",
  ...
  es: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "Para vendedores en crecimiento",
      ...
      packBarDesc: "15 creditos que nunca expiran. Sin compromiso. Perfecto para vaciar tu armario.",
  ...
  it: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "Per venditori in crescita",
      ...
      packBarDesc: "15 crediti che non scadono mai. Senza impegno. Perfetto per svuotare il tuo armadio.",
  ...
  pt: {
    ...
    pricing: {
      ...
      plusPlanName: "Plus",
      plusPlanSubtitle: "Para vendedores em crescimento",
      ...
      packBarDesc: "15 creditos que nunca expiram. Sem compromisso. Perfeito para esvaziar o seu closet.",
