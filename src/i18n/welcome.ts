...
type WelcomeCopy = {
  ...
  primaryCta: string;
  secondaryCta: string;
  selectedPlanTemplate: string;
  continuePlanTemplate: string;
...
export const WELCOME_COPY: Record<WelcomeLocale, WelcomeCopy> = {
  ...
  fr: {
    ...
    selectedPlanTemplate: "{plan} sélectionné",
    continuePlanTemplate: "Continuer avec {plan}",
    openingSignIn: "Ouverture d’AutoLister AI...",
    finishSignIn: "Terminez la connexion pour continuer.",
    openingCheckout: "Ouverture du paiement sécurisé...",
    checkoutError: "Impossible de continuer. Réessayez.",
  ...
  de: {
    ...
    selectedPlanTemplate: "{plan} ausgewählt",
    continuePlanTemplate: "Weiter mit {plan}",
    openingSignIn: "AutoLister AI wird geöffnet...",
    finishSignIn: "Schließe die Anmeldung ab, um fortzufahren.",
    openingCheckout: "Sicherer Checkout wird geöffnet...",
    checkoutError: "Fortfahren nicht möglich. Versuche es erneut.",
    whatsNewBadge: "Neu",
  ...
  nl: {
    ...
    selectedPlanTemplate: "{plan} geselecteerd",
    continuePlanTemplate: "Doorgaan met {plan}",
    openingSignIn: "AutoLister AI openen...",
    finishSignIn: "Rond het inloggen af om door te gaan.",
    openingCheckout: "Beveiligde checkout openen...",
    checkoutError: "Doorgaan is niet gelukt. Probeer het opnieuw.",
    whatsNewBadge: "Nieuw",
  ...
  pl: {
    ...
    selectedPlanTemplate: "Wybrano {plan}",
    continuePlanTemplate: "Kontynuuj z {plan}",
    openingSignIn: "Otwieranie AutoLister AI...",
    finishSignIn: "Dokończ logowanie, aby kontynuować.",
    openingCheckout: "Otwieranie bezpiecznej płatności...",
    checkoutError: "Nie udało się kontynuować. Spróbuj ponownie.",
  ...
  es: {
    ...
    selectedPlanTemplate: "{plan} seleccionado",
    continuePlanTemplate: "Continuar con {plan}",
    openingSignIn: "Abriendo AutoLister AI...",
    finishSignIn: "Completa el inicio de sesión para continuar.",
    openingCheckout: "Abriendo el pago seguro...",
    checkoutError: "No se pudo continuar. Inténtalo de nuevo.",
    whatsNewBadge: "Nuevo",
  ...
  it: {
    ...
    selectedPlanTemplate: "{plan} selezionato",
    continuePlanTemplate: "Continua con {plan}",
    openingSignIn: "Apertura di AutoLister AI...",
    finishSignIn: "Completa l'accesso per continuare.",
    openingCheckout: "Apertura del pagamento sicuro...",
    checkoutError: "Impossibile continuare. Riprova.",
  ...
  pt: {
    ...
    selectedPlanTemplate: "{plan} selecionado",
    continuePlanTemplate: "Continuar com {plan}",
    openingSignIn: "A abrir o AutoLister AI...",
    finishSignIn: "Conclua o início de sessão para continuar.",
    openingCheckout: "A abrir o pagamento seguro...",
    checkoutError: "Não foi possível continuar. Tente novamente.",
    whatsNewBadge: "Novo",
